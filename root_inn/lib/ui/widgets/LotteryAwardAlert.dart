      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            //   ),
            // ),
            // GiftContentView(giftImg: 'assets/lotteryImgs/' + itemModel.icon + '.png',),
            GiftContentView(giftImg: itemModel.icon,),
            Container(
      ...
      child: Stack(
        children: <Widget>[
          Transform.rotate(
            ...
            child: Center(
              child: Image.asset(
                'assets/lotteryImgs/pic_light@3x.png',
                fit: BoxFit.fill,
              ),
            ),
          ),
          ...
          Container(
            ...
            child: Center(
              ...
              child: CachedNetworkImage(
                imageUrl: '${Constant.DUMEI_RESOURCE_SERVER}${widget.giftImg}',
                fit: BoxFit.fill,
